...
{
  brlcad_list_objects(x0);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_brlcad_list_objects(PyObject *self, PyObject *arg0)
{
  char const * x0;
  Py_ssize_t datasize;
  struct _cffi_freeme_s *large_args_free = NULL;
...
{
  return brlcad_open_db(x0);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_brlcad_open_db(PyObject *self, PyObject *arg0)
{
  char const * x0;
  Py_ssize_t datasize;
  struct _cffi_freeme_s *large_args_free = NULL;
...
#else
#  define _cffi_f_brlcad_open_db _cffi_d_brlcad_open_db
#endif
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit__brlcad(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit__brlcad(void) { return NULL; }
#  else
     init_brlcad(void) { }
#  endif
#  endif
...
PyInit__brlcad(void)
{
  return _cffi_init("_brlcad", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
init_brlcad(void)
{
  _cffi_init("_brlcad", 0x2601, &_cffi_type_context);
}
#endif
